...
\begin{align*}
	V_{DC}&=\dfrac{2}{T}\displaystyle{\int_{0}^{\frac{T}{2}} {V_{m}\sin{(\omega t) dt}} }=\dfrac{2V_{m}}{\pi}=0.636V_{m}\\
	V_{RMS}&=\left[ \dfrac{2}{T}\displaystyle{\int_{0}^{\frac{T}{2}} {\left(V_{m}\sin(\omega t)\right)^{2} dt} }\right]^{\frac{1}{2}}=\dfrac{V_{m}}{\sqrt{2}}=0.707V_{m}
\end{align*} 
